...
// Özel sohbet mesajları için arayüz
interface PrivateMessageable {
    val id: String
    val senderId: String
...
abstract class PrivateBaseChatViewModel<M : PrivateMessageable>(
    protected val firebaseAuth: FirebaseAuth
) : ViewModel() {

    companion object {
        private const val BASE_TAG = "PrivateBaseChatViewModel"
    }
